function [samples]=gibbs_sampler_mrf_with_edge_parameters(A,theta_i,theta_c,domain_sizes,burnin,number_samples)
...
while calc_p_all_x(A,x,theta_i,theta_c)==0
