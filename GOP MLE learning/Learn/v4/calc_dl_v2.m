function [ dl_i,dl_c,dlp_i,dlp_c,dl_theta_i,dl_theta_c ] = calc_dl_v2( b_i,b_c,bp_i,bp_c,theta_i,theta_c,w_i,w_i_c,sum_b_i,sum_b_c,lambda,cliques,order_variables,hidden,output,m )
